	...
	<main id="tp_content" role="main">
		...
		<div class="container">
			<div id="primary" class="content-area">
				<?php $cricket_tournament_sidebar_layout = get_theme_mod( 'cricket_tournament_sidebar_page_layout','right');
			        ...
			        <div class="row">
			          	...
			          	<div class="col-md-8 col-sm-8 left-sidebar">
			           		<?php while ( have_posts() ) : the_post();
								...
								wp_link_pages( array(
									'before' => '<div class="page-links">' . __( 'Pages:', 'cricket-tournament' ),
									'after'  => '</div>',
								) );
